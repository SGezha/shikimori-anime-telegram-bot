  ...
  try {
    ...
    kodik.results.forEach(async (a, ind) => {
      ...
      lastDownloadAnimeList.push({
        episodesLinks: Object.keys(a.seasons[a.last_season].episodes).map(key => `https://animebot.smotrel.net/kodik?video=${a.seasons[Object.keys(a.seasons)[a.last_season]].episodes[key]}&title=${a.title_orig}`),
